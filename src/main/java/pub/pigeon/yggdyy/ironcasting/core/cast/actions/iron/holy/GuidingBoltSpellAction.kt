...
class GuidingBoltSpellAction(spell: AbstractSpell, level: Int): AbstractProjectileIronSpellAction(spell, level, true) {
    override fun constructProjectile(env: CastingEnvironment): AbstractMagicProjectile {
        return GuidingBoltProjectile(env.world, env.castingEntity)
    }
